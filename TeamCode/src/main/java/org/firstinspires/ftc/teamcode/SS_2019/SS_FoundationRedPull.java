...
public class SS_FoundationRedPull extends TankBot{
    ...
    public void start() {
        ...
        stateMachine = new StateMachine(
                ...
                new DriveWithHeadingState("move2",0.5,360.0 - start_angle, new ProgressTrans("turn3",4300)),
                new TurnState("turn3",0.5, new ProgressTrans("move3", 14.0)),
                new DriveWithHeadingState("move3", 0.5,90.0 - start_angle, new ProgressTrans("turn4", 1350)),
