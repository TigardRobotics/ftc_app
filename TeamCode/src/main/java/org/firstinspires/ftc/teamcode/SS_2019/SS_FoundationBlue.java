...
public class SS_FoundationBlue extends TankBot{
    ...
    public void start() {
        ...
        stateMachine = new StateMachine(
                ...
                new DriveState("pull",-0.5, new ProgressTrans("turn",3000)),
                new TurnState("turn", -0.5, new ProgressTrans("release", 15.0)),
                new DualGrabberState("release",false, new TimeTrans("turn1",1.0)),
                new TurnState("turn1", -0.5, new ProgressTrans("run",15.0)),
                new DriveState("run", 0.5, new ProgressTrans("wait",1500)),
