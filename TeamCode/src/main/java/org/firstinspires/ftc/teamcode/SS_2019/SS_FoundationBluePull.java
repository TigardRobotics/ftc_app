...
public class SS_FoundationBluePull extends TankBot{
    ...
    public void start() {
        ...
        stateMachine = new StateMachine(
                ...
                new TurnState("adjust", -0.5, new ProgressTrans("inch", 7.0)),
                new DriveWithHeadingState("inch", 0.5,360.0 - start_angle, new ProgressTrans("grab", 260.0)),
                new DualGrabberState("grab",false, new TimeTrans("foundation", 1.0)),
                new DriveState("foundation", -0.5, new ProgressTrans("release",1500)),
                ...
                new DriveWithHeadingState("move2",0.5,360.0 - start_angle, new ProgressTrans("turn3",3000)),
                new TurnState("turn3",0.5, new ProgressTrans("move3", 14.0)),
                new DriveWithHeadingState("move3", 0.5,90.0 - start_angle, new ProgressTrans("turn4", 1500)),
                ...
                new DriveWithHeadingState("parkmove", 0.5,270.0 - start_angle, new ProgressTrans("wait", 2000)),
