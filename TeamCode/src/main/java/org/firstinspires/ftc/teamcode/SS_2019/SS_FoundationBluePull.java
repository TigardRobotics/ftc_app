...
public class SS_FoundationBluePull extends TankBot{
    ...
    public void start() {
        ...
        stateMachine = new StateMachine(
                ...
                new DriveWithHeadingState("inch", 0.5, start_angle, new ProgressTrans("grab", 1250.0)),
                new DualGrabberState("grab",false, new TimeTrans("pullback", 1.0)),
                new DriveState("pullback", -0.5, new ProgressTrans("release",3400)),
                new DualGrabberState("release", true, new TimeTrans("pre-bump", 2.0)),
                ...
                new DriveWithHeadingState("move3", 0.5,270.0 + start_angle, new ProgressTrans("turn4", 1650)),
                ...
                new DriveWithHeadingState("parkmove", 0.5,90.0 + start_angle, new ProgressTrans("wait", 3000)),
