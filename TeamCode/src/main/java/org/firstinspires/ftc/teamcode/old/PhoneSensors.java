/**
 * Code from https://github.com/acharraggi/my_ftc_app/.../ftcrobotcontroller/opmodes/OrientOp.java
 **/
...
/**
 * PhoneSensors
 * Determines direction using the phones Orientation Sensor
 */
@TeleOp(name="PhoneSensors", group="Concept")
public class PhoneSensors extends OpMode implements SensorEventListener{
