...
@Autonomous(name = "SS_Foundation", group = "3965")
...
public class SS_Foundation extends TankBot{
    ...
    public void start() {
        ...
        stateMachine = new StateMachine(
                ...
                new DriveState("move1", 0.5, new ProgressTrans("turn1",600)),
                new TurnState("turn1",-0.5, new ProgressTrans("move2", 18.0) ),
                new DriveState("move2",0.5, new ProgressTrans("turn2",600)),
                new TurnState("turn2",-0.5, new ProgressTrans("move3", 18.0)),
                new TurnState("move3",0.5,new ProgressTrans("wait", 2000)),
